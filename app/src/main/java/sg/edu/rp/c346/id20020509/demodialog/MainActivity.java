package sg.edu.rp.c346.id20020509.demodialog;
        ...
        btnExercise3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                myBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        // Extract the text entered by the user
                        int number1 = Integer.parseInt(etInput2.getText().toString());
                        int number2 = Integer.parseInt(etInput3.getText().toString());
